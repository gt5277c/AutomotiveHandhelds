...
public class TADSBeanProcessor extends BeanProcessor{
    ...
    /**
     * Constructor for TADSBeanProcessor.
     */
    public TADSBeanProcessor() {
        this(new HashMap<String, String>());
    }

    /**
     * Constructor for TADSBeanProcessor configured with column to property name overrides.
     */
    public TADSBeanProcessor(Map<String, String> columnToPropertyOverrides) {
        super();
    ...
    public <T> T toBean(ResultSet rs, Class<? extends T> type) throws SQLException {
        TADSLocationObject bean = (TADSLocationObject) this.newInstance(type);
        bean.setLocationDatabase(database);
    ...
    public <T> List<T> toBeanList(ResultSet rs, Class<? extends T> type) throws SQLException {
        ...
        do { 
        	TADSLocationObject tlo = createTADSBean(rs, (Class<TADSLocationObject>) type, props, columnToProperty);
        	results.add((T) tlo);
        } while (rs.next());
    ...
    private <T extends TADSLocationObject> TADSLocationObject createTADSBean(ResultSet rs, Class<TADSLocationObject> type,
                             PropertyDescriptor[] props, int[] columnToProperty)
    throws SQLException {

    	TADSLocationObject bean = this.newInstance(type);
        bean.setLocationDatabase(database);
	...
	protected Object processColumn(ResultSet rs, int index, Class<?> propType)
        ...
        for (ColumnHandler handler : columnHandlers) {
            if (handler.match(propType)) {
            	if(handler instanceof BooleanColumnHandler) {
